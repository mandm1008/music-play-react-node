...
const playlist = await import("./svgs/playlist.svg").then(
  (value) => value.default
);
const history = await import("./svgs/history.svg").then(
  (value) => value.default
);
...
const uploadMusic = await import("./svgs/uploadMusic.svg").then(
  (value) => value.default
);
const loading = await import("./svgs/loading.svg").then(
  (value) => value.default
);
